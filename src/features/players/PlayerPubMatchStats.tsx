    ...
    <div className="bg-slate-800/30 border-t border-slate-700 p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          disabled={isFetching}
          className="px-4 py-2 bg-blue-500 hover:bg-blue-600 disabled:bg-blue-500/50 disabled:cursor-not-allowed text-white rounded-md transition-colors flex items-center gap-2"
        >
          <svg
